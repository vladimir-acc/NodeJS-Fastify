...
const courses = require('../app/api/courses/courses.js');
const courseTerms = require('../app/api/courses/terms.js');
...
const routes = {
  ...
  senior: senior(),
  courses: courses(),
  types_of_courses: db('types_of_courses'),
  courseTerms: db('courseTerms'),
};
